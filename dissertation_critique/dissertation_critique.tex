...
Support Vector Machines (SVM) are well established for their utility in classification problems. An SVM functions by discovering a hyperplane that maximizes the margin of seperation between two classes given their feature space.


\citep{Forman} states SVM is good for text classification.
