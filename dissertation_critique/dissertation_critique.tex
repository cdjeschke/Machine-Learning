...
\[
  y_{i}(w \cdot x_{i} + b) \geq 1,  i = 1, ...., l
\]
...
\subsection{Na\"ive Bayes Classification}
...
\[
  \hat{y} = argmax_{k \in (wl, nwl)} p(C_{k}) \prod_{i=1}^{n}p(x_{i}|C_{k})
\]
