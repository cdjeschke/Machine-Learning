...
Support Vector Machines (SVM) \citep{Vapnik} are well established for their utility in classification problems. An SVM functions by discovering a hyperplane that maximizes the margin of seperation between two classes given their feature space. The simplest SVM finds the optimal hyperplane (w,b) satisfying the inequality:
\[
