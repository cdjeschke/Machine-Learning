...
Pang and Lee discuss the tools and implications of treating online opinions as a first class object - something we actively mine for and take value in. 
...
- What to read:
- Edwards and Aronson (2000) - no bibliography
- CHF patients.com  (Kendall, 1999) - no bibliography
- (Houston, Cooper, and Ford, 2002) - no bibliography
- HIPAA/HITECH (not relevant)


- (Pang and Lee, 2008) positve & negative sentiment

NER`
- Nadue & Sekine (2007) - named entity Recognition
- Rindsfleich, Tanabe and Weinstein (2002) identified drugs and relations in biomedical literature
- SVMs (Cortes and Vapnik, 1995)
- BNS (Forman)
- Naive Bayes (Manning, 1999)
- McDowell, 2006 - quality of life ,  HRQOL metrics
